...
/**
 * RE-EXPORTED, NOT REDEFINED. The production copier reads the same published
 * credential file, and two parsers of one format is one parser too many.
 */
export { parseCredentialUrl, type ParsedCredential } from '../src/pg-copy/export-role.js'
import { parseCredentialUrl, type ParsedCredential } from '../src/pg-copy/export-role.js'
