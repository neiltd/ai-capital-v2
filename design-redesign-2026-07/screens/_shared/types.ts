...
//
// Canonical envelope types come from `@common/types` (Position, AnalysisJSON,
// SimulationJSON, DiscoveryJSON, IntelligenceJSON) — the shapes below are
// re-declared here only so this proposal folder is self-contained; in the
// real app, import from '@common/types' and delete the duplicates.
//
// Types marked `// GAP:` describe data the backend does not yet produce —
// see ../../backend-gaps.md for the build list.
...
export interface Position {
  ...
  unrealizedPnl: number // native currency
  updatedAt: string
