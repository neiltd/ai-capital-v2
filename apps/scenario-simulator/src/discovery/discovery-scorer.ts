...
THAI-MARKET-ONLY sub-screen (apply ONLY to Thai tickers ending in .BK): additionally penalize companies whose durability rests on STATE ENTWINEMENT rather than a genuine competitive flywheel — government concessions/PPAs, royal or state ownership, or political-connection-as-moat (the crony-capital pattern). Favor Thai names whose moat is product/brand/network/execution, not a license or a patron. Do NOT apply this sub-screen to US names: there, government-contract dependence (e.g. defense primes, regulated utilities) is a normal sector feature, not a governance red flag.
